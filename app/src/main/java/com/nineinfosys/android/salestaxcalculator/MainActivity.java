package com.nineinfosys.android.salestaxcalculator;
...
import com.nineinfosys.android.salestaxcalculator.Contacts.Contacts;
import com.nineinfosys.android.salestaxcalculator.LoginActivity.Login;
...
EditText amount,tax;
    Button finalvaluecal,clearbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authenticate();
        finalvaluecal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (amount.getText().toString().equals("")) {
                    ...
                    salestax = new SalesTaxCal(amountval, taxval);
